...
(function() {
  var achievements = {
    achievementsList: [
      ...
      {
        name: 'lightbot_achievement_complete_levels_20',
        title: 'Master',
        message: 'Complete 20 levels.',
        check: function() {
          if (getCompletedLevelCount() >= 20) {
            return true;
          }
          return false;
        }
      ...
      {
        name: 'lightbot_achievement_complete_levels_25',
        title: 'Legend',
        message: 'Complete 25 levels.',
        check: function() {
          if (getCompletedLevelCount() >= 25) {
            return true;
          }
          return false;
        }
      ...
      {
        name: 'lightbot_achievement_complete_levels_40',
        title: 'Ultimate Master',
        message: 'Complete 40 levels.',
        check: function() {
          if (getCompletedLevelCount() >= 40) {
            return true;
          }
          return false;
        }
